...
public class Administrador {
    ...
    /*
    public void alterarInformacaoProfessor(Professor professor) {
       
    }

    public void alterarInformacaoCurso(Curso curso) {
        
    }

    public void alterarInformacaoUC(UnidadeCurricular unidadeCurricular) {
