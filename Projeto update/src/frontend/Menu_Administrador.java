...
public class Menu_Administrador{
    ...
    public static void auth(ListaCursos cursos, ListaUC ucs, ListaProfessores profs, ListaAluno alunos, Sistema sistema){
                ...
                Administrador administrador = new Administrador();
                    ...
                    if (administrador.autenticar(username, senha) == true){
                        ...
                        Menu_Administrador.menu(cursos,ucs,profs,alunos,administrador, sistema);
                    } else {
    ...
    public static void menu(ListaCursos cursos, ListaUC ucs, ListaProfessores profs, ListaAluno alunos, Administrador admin, Sistema sistema){
                int opcaoAdm = -1;
		...
		System.out.println("* 17 -> Remover aluno                                                    *");
                ...
                switch(opcaoAdm){
                    ...
                    case 1: 
                        ...
                        profs.criarProfessor(ucs,cursos, sistema);
                        break;                
                    case 2:
                    ...
                    case 3:
                        ...
                        profs.alterarInformacaoProfessor(ucs, cursos);
                        break;
                    case 4: 
			...
			System.out.println("Atribuir regência de UC a professor: ");
                        admin.atribuirRegenciaUC(profs, ucs);
			break;
                    case 6: 
			System.out.println("Atribuir direção de curso a professor: ");
                        admin.atribuirDirecaoCurso(profs, cursos);
			break;
                    case 7: 
			...
			System.out.println("Criar aluno: ");
                        alunos.criarAluno(cursos, sistema);
			break;
                    case 16:
			System.out.println("Listar alunos: ");
                    ...
                    case 18:
                        ...
                        alunos.alterarInformacaoAluno(cursos);
                        break;
                    case 0:  
